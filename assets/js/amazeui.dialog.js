...
dialog.tip = function (options) {
	...
	html.push('<div class="am-modal-bd" style="min-width:240px; color:#fff; font-Size:16px;">' + options.tip + '</div>');
	html.push('</div>');
	html.push('</div>');
...
dialog.alert = function(options) {
  ...
  html.push('<div class="am-modal-footer"><span class="am-modal-btn">' + options.btnConfirm + '</span></div>');
  html.push('</div>');
  html.push('</div>');
...
dialog.confirm = function(options) {
  ...
  options.content = options.content || '提示内容';
  options.btnConfirm = options.btnConfirm || 'Ok';
  options.btnCancel = options.btnCancel || 'Cancel';
  options.onConfirm = options.onConfirm || function() {
    };
  ...
  html.push('<span class="am-modal-btn" data-am-modal-cancel>' + options.btnCancel + '</span>');
  html.push('<span class="am-modal-btn" data-am-modal-confirm>' + options.btnConfirm + '</span>');
  html.push('</div>');
  html.push('</div>');
  html.push('</div>');
